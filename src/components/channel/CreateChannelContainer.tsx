export const CreateChannelContainer = () => {
	return (
		<div className="mx-auto h-[50.312rem] w-[393px] bg-[#ffffff]">
			<div className="flex h-[50.312rem] flex-col justify-end gap-4">
				<h1 className=" ml-4 text-[26px] font-bold">채널 생성</h1>
				<div
				...
				>
					...
					/>
					<p className="mx-auto mt-16 text-[14px] font-normal text-[#3d348b]">
